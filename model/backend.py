...
class Yolo2Feature(object):

    def __init__(self, input_size, backend_weights):
        input_image = Input(shape=(input_size, input_size, 3))

        # wrapper alla funzione di Tensorflow con block_size=2
        # il motivo è che usandola all'interno di una "lambda", non ci sarebbe altro modo di impostare il block_size
